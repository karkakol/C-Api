...
namespace AnimalReviewApp.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        [ProducesResponseType(400)]
        public IActionResult GetAnimalByCategory(int categoryId) {

            var Animals = _mapper.Map<List<AnimalDto>>(_categoryRepository.GetAnimalByCategory(categoryId));
        ...
        public IActionResult CreateCategory([FromBody] CategoryDto newCategory)
        {
            ...
            var category = _categoryRepository.GetCategories()
                .Where(c => c.Name.Trim().ToUpper() == newCategory.Name.TrimEnd().ToUpper()).FirstOrDefault();
