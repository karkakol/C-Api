...
namespace AnimalReviewApp.Controllers
{
    ...
    public class ReviewController : Controller
    {
        ...
        public IActionResult GetAnimal(int reviewId)
        {
        ...
        [HttpGet("Animal/{pokeId}")]
        [ProducesResponseType(200, Type = typeof(Review))]
        [ProducesResponseType(400)]
        public IActionResult GetReviewsForAAnimal(int pokeId)
        {
            var reviews = _mapper.Map<List<ReviewDto>>(_reviewRepository.GetReviewsOfAAnimal(pokeId));
        ...
        public IActionResult CreateReview([FromQuery] int reviewerId, [FromQuery] int pokeId, [FromBody] ReviewDto reviewCreate)
        {
            ...
            reviewMap.Animal = _AnimalRepository.GetAnimal(pokeId);
